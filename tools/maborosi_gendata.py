...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='maborosi-skeleton Data Converter.')
    parser.add_argument(
        '--data_path', default='data/maborosi/maborosi-skeleton')
    parser.add_argument(
        '--out_folder', default='data/maborosi/maborosi-skeleton')
    arg = parser.parse_args()

    part = ['train', 'val']
    for p in part:
        data_path = '{}/maborosi_{}'.format(arg.data_path, p)
        label_path = '{}/maborosi_{}_label.json'.format(arg.data_path, p)
